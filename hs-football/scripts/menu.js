/*
 * IE 7 (wrap) FIXES BY Hiroto
 * November 2nd 2006 - Hiroto --> change done line of code to fix IE7 wrap bug
 * chnage  to var itemProps = 'white-space:nowrap;'
 * STYLE FIXES BY Shane Andrusiak
 * April 20th 2006 - Shane Andrusiak --> Updated and fixed various css problems.
 * Instances of 'hand' change to 'pointer'n on cursor style
 * Instances of 'fontSize' change to 'font-size' for standards
 * Instances of 'font-weight:plain' change to 'font-weight:normal' for standards
 */
function Menu(label, mw, mh, fnt, fs, fclr, fhclr, bg, bgh, halgn, valgn, pad, space, to, sx, sy, srel, opq, vert, idt, aw, ah)
{
    ...
    this.childMenuIcon = "/pics/arrows.gif";
