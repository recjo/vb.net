<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jrmidget.aspx.vb" Inherits="teamnews_jrmidget" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="WebContentDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Team News - JrMidget" Name="PageName" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    
    
    <br /><br />
    <asp:HiddenField ID="hfLeague" runat="server" Value="jrmidget" />
