<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jrpeeweered.aspx.vb" Inherits="teamnews_jrpeeweered" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="WebContentDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Team News - JrPeeWeeRed" Name="PageName" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
    
    
    <br /><br />
    <asp:HiddenField ID="hfLeague" runat="server" Value="jrpeeweered" />
