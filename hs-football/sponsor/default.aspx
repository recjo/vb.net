<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="sponsor_default" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="WebContentDataSource" runat="server"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Sponsor" Name="PageName" Type="String" />
        </SelectParameters>
